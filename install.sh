#!/usr/bin/env sh
# Universal installer for introbot. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/introbot.git"
echo "Installing introbot ..."
